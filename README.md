...
result returned from the parser, as described in the
[Parse Result](#parser-result) section.
...
the hood, the [Conditional](#conditional-expressions) and
[Permutations](#permutations-expressions) Utility Expressions are implemented
